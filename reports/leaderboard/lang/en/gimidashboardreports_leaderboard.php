...
$string['fastesttofinishdesc'] = 'Time from first course access to course completion. Shorter time ranks higher.';
$string['fastesttofinishtop5'] = 'Leaderboard - Fastest to Finish - TOP 5';
$string['fastesttofinishtop5desc'] = 'Top 5 learners with the shortest time between first course access and course completion date. Hours, minutes and seconds are used when needed.';
