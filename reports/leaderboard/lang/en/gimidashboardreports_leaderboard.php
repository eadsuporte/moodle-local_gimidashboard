...
$string['bestgradedesccourse'] = 'Average exam grade for the selected course only.';
$string['bestgradedescpathway'] = 'Average exam grade across pathway courses where an exam score exists.';
...
$string['durationlabel'] = 'Elapsed time';
...
$string['fastestpathwaydetails'] = '{$a->course} • Finished on {$a->date}';
$string['fastesttofinish'] = 'Fastest to Finish';
$string['fastesttofinishdesc'] = 'Time from first course access to course completion, calculated in seconds and displayed in hours or minutes. Shorter time ranks higher.';
$string['fastesttofinishtop5'] = 'Leaderboard - Fastest to Finish - TOP 5';
$string['fastesttofinishtop5desc'] = 'Top 5 learners with the shortest time between first course access and course completion. The metric is calculated in seconds and displayed in hours or minutes when needed.';
$string['finishdate'] = 'Finish Date';
$string['finishedon'] = 'Finished on {$a}';
$string['grade'] = 'Grade';
...
$string['notrankedfinishaccess'] = 'Listed without rank until a first course access and course completion date are both available.';
